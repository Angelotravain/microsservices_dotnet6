    ...
    public class RabbitMQMessageSender : IRabbitMQMessageSender
    {
        ...
        public void SendMessage(BaseMessage message, string queueName)
        {
            if (ConnectionExists())
            {
                ...
                channel.BasicPublish(exchange: "PaymentEmail", routingKey: queueName, basicProperties: null, body: body);
                channel.BasicPublish(exchange: "PaymentOrder", routingKey: queueName, basicProperties: null, body: body);
            }
        }
